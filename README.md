...
//To find the biggest among three
#include<stdio.h>
int main()
{
...
//to check whether the number is in  the range 01 to 100
#include<stdio.h>
int main()
{
int num;
...
//to describe odd numbers from one to 10
#include<stdio.h>
void main()
{
int i=1;
...
//To find the first 10 natural numbers
#include<stdio.h>
void main()
{
int i=1,sum=0;
...
//To check the number in the range of 1 to 200
#include<stdio.h>
int main()
{
int num;
...
//To make the arrays in reverse order
#include<stdio.h>
void main()
{
int i,n,a[100];
...
//To find the average of array elements
#include<stdio.h>
void main()
{
...
//To find the given elment in a array
#include<stdio.h>
void main()
{
...
//To find the smallest integer in an array
#include<stdio.h>
void main()
{
int i,n,a[100],smallest;
printf("Enter number of elements: ");
scanf("%d",&n);
printf("Enter the integers:\n");
for(i=0;i<n;i++)
...
//To sort the element sin the array descending order
#include<stdio.h>
void main()
{
int i,j,n,a[100],temp;
...
//To count the positive and negative number in an array
#include<stdio.h>
void main()
{
int i,n,a[100],positive=0,negative=0;
printf("Enter number of elements: ");
scanf("%d",&n);
printf("Enter the integers:\n");
for(i=0;i<n;i++)
...
//To find the frequeny of the array
#include<stdio.h>
void main()
{
...
//To reverse a string without string functions
#include<stdio.h>
#include<string.h>
int main()
{
char str[20]="PARHASARADHI";
char rev[20];
int i,j=0,l;
l=strlen(str);
for (i=l-1;i>=0;i--){
...
//To print the palindrome using string
#include<stdio.h>
#include<string.h>
void main()
{
...
//To count the no of vowels and consonants in a sentence
#include<stdio.h>
void main()
{
char sentence[30]="savarapu spandana";
...
//To check if the given string is a pangram
#include<stdio.h>
#include<string.h>
